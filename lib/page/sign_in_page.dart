...
class _SignInPageState extends State<SignInPage> {
  ...
  Widget build(BuildContext context) {
    ...
    handleSignIn() async {
      ...
      // String url = "http://10.0.2.2/api/auth/login";

      var url = Uri.https('api.foodmarket.technosolution.site', '/api/login');

      var respons = await http.post(url,
          headers: {'Content-Type': 'application/json'}, body: postData);
      // var responsData = json.decode(respons.body);
      // print(respons.body);
      ...
      // print(await authProvider.login(
